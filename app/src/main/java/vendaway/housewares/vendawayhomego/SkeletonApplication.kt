...
import vendaway.housewares.vendawayhomego.di.dataModule
import vendaway.housewares.vendawayhomego.di.dispatcherModule
import vendaway.housewares.vendawayhomego.di.viewModule
...
class OJFXTApplication : Application() {
    //[FIREBASE][appScope]
    ...
    override fun onCreate() {
        ...
        startKoin {
            androidLogger()
            androidContext(this@OJFXTApplication)
            modules(appModules)
        }
